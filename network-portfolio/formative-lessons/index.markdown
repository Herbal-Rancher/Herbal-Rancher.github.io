...
{% assign visible_posts = visible_posts | push: post %}ndif %}
{% endfor %}
{% endif %}
{% e assign sortedsts.size > 0 %}

{{ post.sort_orein: 1.5rem 0; padding: 1rem; border: 1px solid #ddd; border-radius: 10px; background: #fafafa;">
...
{% for post in sorted_visible_po{% if post.categories contains "assessment" or post.categories contains "milestone" or post.categories contains "summative" or post.categories contains "discussion" %}
...
--- 
<p>
 18 focus on hands-on implementation, troubleshooting, security analysis, virtual labs, remote administration, and applied networking skills.
</p>
...
---
--- 
<divin-left: 1.25rem; margin-top: 1rem; padding-left: 1rem; border-left: 3px solid #e5e5e5;">
