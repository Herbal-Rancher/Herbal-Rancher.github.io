...
tags: [linux, windows, dns, nslookup, terminal, networking, network-plus]
permalink: /portfolio/labs/module-6-0/use-nslookup/
status: complete
...
tools: [nslookup, ip, ping]
protocols: [DNS]
topics: [dns-resolution, mx-records, terminal-commands]
---
